...
ACTION_REGISTRY: list[ActionDef] = [
    ...
    ActionDef("toggle_word_wrap", "自动换行", "both", "视图", "切换文档长行是否自动换行。",
              {"browse": "ctrl+shift+r", "edit": "ctrl+shift+r"}),
    ...
    ActionDef("copy_rich", "复制为富文本", "both", "编辑", "将选区内容转为 HTML 富文本复制到剪贴板。",
              {"browse": "ctrl+shift+c", "edit": "ctrl+shift+c"}),
    ActionDef("global_find", "全局查找", "both", "视图", "在侧边栏搜索面板中跨文件查找。",
              {"browse": "ctrl+shift+f", "edit": "ctrl+shift+f"}),
    ActionDef("format_underline", "下划线", "edit", "行内格式", "选中文本包裹 <u> 标签（HTML 下划线）。",
              {"edit": "ctrl+u"}),
    ActionDef("insert_image", "插入图片", "edit", "行内格式", "在光标处插入图片语法 ![](url)。",
              {"edit": "ctrl+shift+i"}),
